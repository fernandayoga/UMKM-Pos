        ...
        <div className="flex flex-1 flex-col sm:flex-row gap-2.5 w-full">
          ...
          <div className="w-full sm:w-48">
            <select
              ...
              className="w-full h-9 px-3 rounded-lg border border-slate-300 bg-white text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
            >
