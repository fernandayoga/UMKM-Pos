          ...
          <div className="flex flex-wrap gap-1.5">
            {suggestedQuestions.map((q) => (
              <button
                ...
                disabled={isLoading}
                className="text-[11px] px-2.5 py-1 bg-white border border-slate-200 rounded-lg text-slate-700 hover:border-emerald-400 hover:text-emerald-700 transition-colors text-left disabled:opacity-50"
              >
                {q}
              </button>
            ))}
          ...
          {isLoading && (
            <div className="flex items-center gap-2 text-xs text-slate-500 pl-8 pt-1">
              <div className="flex gap-1">
                ...
                <span className="w-1.5 h-1.5 bg-emerald-600 rounded-full animate-pulse delay-150" />
                <span className="w-1.5 h-1.5 bg-emerald-600 rounded-full animate-pulse delay-300" />
              </div>
        ...
        <div className="p-3 border-t border-slate-200 bg-white">
          ...
          >
            <input
              ...
              disabled={isLoading}
              className="flex-1 px-3 py-2 text-xs rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-600"
            />
            <button
              type="submit"
              disabled={!input.trim() || isLoading}
              className="p-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 disabled:opacity-40 transition-colors"
              aria-label="Kirim"
            >
